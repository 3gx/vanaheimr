...
public:
    ...
    __alloc_rr&           __alloc()         {return __end_cap_.second();}
    ...
    bool empty()     const {return __end_ == __begin_;}
    size_type capacity() const {return static_cast<size_type>(__end_cap() - __first_);}
    size_type __front_spare() const {return static_cast<size_type>(__begin_ - __first_);}
    size_type __back_spare() const {return static_cast<size_type>(__end_cap() - __end_);}
...
private:
    ...
    void __move_assign_alloc(__split_buffer&, false_type)
        {}
    ...
    static void __swap_alloc(__alloc_rr&, __alloc_rr&, false_type)
        {}
};
