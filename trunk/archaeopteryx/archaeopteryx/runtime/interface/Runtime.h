...
class Runtime
{
    ...
    private:
        __device__ static ir::Binary*              m_loadedBinary;
        __device__ static void*                    m_physicalMemory;
        __device__ static executive::CoreSimKernel m_kernel;
        __device__ static executive::CoreSimBlock* m_blocks;//an array of blocks?
        __device__ static unsigned int             m_simulatedBlocks;
        __device__ static ir::Binary::PC           m_launchSimulationAtPC;
    private:
