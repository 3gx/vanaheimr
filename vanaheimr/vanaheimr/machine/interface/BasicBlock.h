...
namespace vanaheimr { namespace machine { class Function;    } }
...
class BasicBlock : public vanaheimr::ir::Variable
{
public:
...
public:
	/*! \brief Get an iterator to an instruction in the block */
